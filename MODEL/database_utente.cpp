...
info_utente database_utente::get_infoUtente(int ID) const{
    ...
    if(!u)
    {
        return info_utente(0,"utente non presente", "utente non presente", "utente non presente", "utente non presente","utente non presente","utente non presente","utente non presente");
    }
