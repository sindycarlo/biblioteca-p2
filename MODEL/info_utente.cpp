...
info_utente::info_utente(QString n ="Sconosciuto", QString c ="Sconosciuto", QString  id ="Sconosciuto", QString psw ="Sconosciuto", QString cf ="Sconosciuto", QString det ="Sconosciuto", database *p =0) : nome(n), cognome(c), ID(id), password(psw), codicefiscale(cf), dettaglio(det), punt(p){}
