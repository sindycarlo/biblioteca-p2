...
info_utente::info_utente(database* p,QString n ="Sconosciuto", QString c ="Sconosciuto", QString  id ="Sconosciuto", QString psw ="Sconosciuto", QString cf ="Sconosciuto", QString det ="Sconosciuto",QString tu ="Sconosciuto") : nome(n), cognome(c), ID(id), password(psw), codicefiscale(cf), dettaglio(det), tipoutente(tu), punt(p){}
...
QString info_utente::get_tipoutente() const{return tipoutente;}
