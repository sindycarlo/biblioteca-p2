...
c_utentewindow::c_utentewindow(unsigned int id,database* db,database_utente* udb,utenteWindow* v, QObject *parent) :  QObject(parent),idutente(id),model(db),modelutenti(udb),view(v) {
