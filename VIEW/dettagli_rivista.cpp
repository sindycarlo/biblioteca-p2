...
#include <QPalette>
dettagli_Rivista::dettagli_Rivista(int Id, database* db,database_utente*udb,database_utente_opere*uodb) : dettagli_opera(Id,db,udb,uodb)
{
...
void dettagli_Rivista::costruisci_contenuto(){
     ...
     info_opera iRivista=(get_model())->get_infoOpera(get_ID());
